...
class ResNet_modify(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=100, use_cos=False, cos_temp=8, nf=64):
        ...
        self.classifier = model.classifier.Classifier(self.out_dim, num_classes, cos_temp)
...
def ResNet32(num_classes, use_cos, cos_temp):
    return ResNet_modify(BasicBlock_s, [5, 5, 5], num_classes, use_cos, cos_temp)
