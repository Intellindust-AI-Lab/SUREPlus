...
def get_args_parser():
    ...
    ## optimizer
    parser.add_argument('--lr', default=0.001, type=float, help='Max learning rate for cosine learning rate scheduler')
    parser.add_argument('--weight-decay', default=5e-4, type=float, help='Weight decay')
    parser.add_argument('--momentum', default=0.9, type=float, help='Momentum')

    ## loss
    parser.add_argument('--loss', default='ce', type=str, help='classification loss')
    parser.add_argument('--label-smoothing', default=0.0, type=float, help='label smoothing of ce loss')

    ## CutMix
    parser.add_argument('--cutmix-weight', default=0.0, type=float, help='Mosaic loss weight')
    parser.add_argument('--cutmix-beta', default=1.0, type=float, help='Mosaic end epochs')
    parser.add_argument('--cutmix-prob', default=1.0, type=float, help='Mosaic end epochs')
    
    parser.add_argument('--rebn', action='store_true', default=False,  help='EMA ReBN')
    ...
    parser.add_argument('--sigma',  default=1, type=float, metavar='S', help='sigma for FriendlySAM')
    parser.add_argument('--lmbda',  default=0.8, type=float, metavar='L', help='lambda for FriendlySAM')
    parser.add_argument('--rho',  default=0.2, type=float, metavar='RHO', help='rho for sam')

    parser.add_argument('--per_epoch_scheduler', action='store_true', default=False, help='whether apply the scheduler per epoch, if not it will be per iteration style. ')
    ...
    parser.add_argument('--swa-epoch-start', default=80, type=int, help='swa start epoch')
    ...
    Cifar100.add_argument("--train-dir", type=str, default='/datassd/CIFAR100/train', help="Cifar100 train directory")
    Cifar100.add_argument("--val-dir", type=str, default='/datassd//CIFAR100/val', help="Cifar100 val directory")
    Cifar100.add_argument("--test-dir", type=str, default='/datassd/CIFAR100/test', help="Cifar100 val directory")
    ...
    ImgNet1k.add_argument('--data-name', default='imagenet1k', type=str, help='Dataset name')
    ImgNet1k.add_argument("--train-dir", type=str, default='/data6022/Inet1K/train', help="ImgNet1K train directory")
    ImgNet1k.add_argument("--val-dir", type=str, default='/data6022/Inet1K/val', help="ImgNet1K val directory")
    ImgNet1k.add_argument("--test-dir", type=str, default='/data6022/Inet1K/val', help="ImgNet1K test directory")
