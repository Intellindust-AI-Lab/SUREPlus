...
def get_args_parser():
    ...
    parser.add_argument('--deit-path', default='/data9022/pretrained_model/DEIT/deit_base_patch16_224-b5f2ef4d.pth', type=str,
    ...
    parser.add_argument('--ema-model', action='store_true', default=False, help='whether evaluate ema model ')
    
    parser.add_argument('--cos-temp', type=int, default=8, help='temperature for scaling cosine similarity')
    parser.add_argument('--loss', type=str, default='ce')
    parser.add_argument('--ood_metric', type=str, default='ce')

    # PixMix
    parser.add_argument('--mosaic-weight', default=0.5, type=float, help='Mosaic loss weight')
    parser.add_argument('--pixmix-weight', default=1.0, type=float, help='weight of PixMix')
    parser.add_argument('--pixmix-path', default='/data/PixMixSet/fractals_and_fvis/first_layers_resized256_onevis', type=str, help='path of PixMix dataset')
    ...
    parser.add_argument('--cutout', action='store_true', default=False, help='whether apply cutout. ')
    ...
    Cifar100.add_argument("--train-dir", type=str, default='/data9022/liyang/datasets/CIFAR100/train', help="Cifar100 train directory")
    Cifar100.add_argument("--val-dir", type=str, default='/data9022/liyang/datasets/CIFAR100/val', help="Cifar100 val directory")
    Cifar100.add_argument("--test-dir", type=str, default='/data9022/liyang/datasets/CIFAR100/test', help="Cifar100 val directory")
    ...
    ImgNet1k.add_argument("--train-dir", type=str, default='/data/Inet1K/train', help="ImgNet1K train directory")
    ImgNet1k.add_argument("--val-dir", type=str, default='/data/Inet1K/val', help="ImgNet1K val directory")
    ImgNet1k.add_argument("--test-dir", type=str, default='/data/Inet1K/val', help="ImgNet1K test directory")
