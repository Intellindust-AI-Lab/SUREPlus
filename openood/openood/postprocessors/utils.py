...
from .msp_postprocessor import MSPPostprocessor
from .sirc_postprocessor import SIRCPostprocessor
...
def get_postprocessor(config: Config):
	...
	'nci': NCIPostprocessor,
        ...
        'sirc_hl': SIRCPostprocessor,
        'sirc_hr': SIRCPostprocessor,
        'sirc_ml': SIRCPostprocessor,
        'sirc_mr': SIRCPostprocessor
    }
