...
class DeiTBasePatch16_CSC(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.backbone.head  = Classifier(self.feature_size, 1000, 64.0)
    ...
    def get_fc(self):
        ...
        return fc.weight.t().detach().cpu().numpy(), fc.bias.detach().cpu().numpy()
