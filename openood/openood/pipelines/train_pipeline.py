...
class TrainPipeline:
    ...
    def run(self):
        ...
        for epoch_idx in range(1, self.config.optimizer.num_epochs + 1):
            # if self.config.network.name.startswith('dinov3'):
            #     if epoch_idx == 1:
            #         print("Epoch 1: training head only...")
            #         for name, param in net.module.backbone.named_parameters():
            ...
            #     elif epoch_idx == 2:
            #         print("Epoch 2: unfreeze all parameters...")
